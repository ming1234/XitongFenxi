...
<div id="header">
	...
	<ul class="hidden_menu">
		<li>
			<a class="clickNote" href="/Xitong/index.php/Home/Books/myAllNotes">我的笔记</a>
		</li>
		<li>
			<a class="clickNote" href="/Xitong/index.php/Home/Books/allNotes">所有笔记</a>
		</li>
		<li>
			<a class="clickNote" href="/Xitong/index.php/Home/Books/allBooks">所有书目</a>
		</li>
	</ul>
</div>
...
<div class="container" id="bookList">
	<!-- 书的列表 -->
	<h5>书的列表</h5>
	<?php $__FOR_START_2012__=0;$__FOR_END_2012__=$countBooks;for($i=$__FOR_START_2012__;$i < $__FOR_END_2012__;$i+=1){ ?><div id="book">
			...
			<div class="form">
				<form method="post" action="/Xitong/index.php/Home/Books/lookComments">
					<input type="hidden" name="id" value="<?php echo ($allBooks[0][id]); ?>" />
					<input type="submit" value="<<< 查看书评" />
				</form>
				<form method="post" action="/Xitong/index.php/Home/Books/lookNotes">
					<input type="hidden" name="id" value="<?php echo ($allBooks[0][id]); ?>" />

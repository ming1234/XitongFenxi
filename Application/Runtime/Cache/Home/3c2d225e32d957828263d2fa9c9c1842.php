...
<div id="header">
	...
	<ul class="hidden_menu">
		...
		<li>
			<a class="clickNote" href="/Xitong/index.php/Home/Comments/allNotes">所有笔记</a>
		</li>
		<li>
			<a class="clickNote" href="/Xitong/index.php/Home/Comments/allBooks">所有书目</a>
		</li>
	</ul>
</div>
...
<!-- 书的信息 -->
	<div id="book">
		...
		<img src="/Xitong/Uploads/BookPhotoes/<?php echo ((isset($bookInfo[picture] ) && ($bookInfo[picture] !== ""))?($bookInfo[picture] ):'/Xitong/Public/img/1.jpg'); ?>">
		<div id="bookInfo">
	...
	<!-- 书评列表 -->
	<h5>书评列表</h5>
	<?php $__FOR_START_16006__=0;$__FOR_END_16006__=$commentsCount;for($i=$__FOR_START_16006__;$i < $__FOR_END_16006__;$i+=1){ ?><div class="commentsList">
			...
			<div>
				...
				<span><?php echo date("Y-m-d ", $commentsList[$i][create_time]) ?></span>
			</div>
		</div><?php } ?>
</div>
